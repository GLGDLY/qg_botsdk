class EVENTS:
    MESSAGE_CREATE = ("AT_MESSAGE_CREATE", "MESSAGE_CREATE", "GROUP_AT_MESSAGE_CREATE", "C2C_MESSAGE_CREATE")
    ...
    GROUP = ("GROUP_ADD_ROBOT", "GROUP_DEL_ROBOT", "GROUP_MSG_REJECT", "GROUP_MSG_RECEIVE")
